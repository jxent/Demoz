...
public class ElasticScrollView extends ScrollView {
    ...
    /**
     * 控件的核心就是在每个事件分发前dispatchTouchEvent对滑动中控件的位置做处理
     * 以及调用onLayout对控件进行重新布局
     */
    ...
    // 手指按下时记录是否已经到达可以继续下拉的位置
    private boolean canPullDown = false;

    // 手指按下时记录是否已经到达可以继续上拉的位置
